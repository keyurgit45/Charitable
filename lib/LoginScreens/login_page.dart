...
import 'package:charitable/utils/bubble_indication_painter.dart';
        ...
        children: <Widget>[
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: MaterialButton(
                    highlightColor: Colors.transparent,
                    splashColor: MyColors.loginGradientEnd,
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () async {
                bool isNew = await LoginHelper.signInWithGoogle();
                if (isNew) {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => ProfilePage(
                          // cName: ["Sign in with google button", "Name"],
                          )));
                } else {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => Home(
                          // cName: ["Sign in with google button"],
                          )));
                }
              },
              child: Container(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () async {
                      print(signupEmailController.text.contains("@"));
                      if (signupNameController.text != null &&
                          signupEmailController.text != null &&
                          signupPasswordController.text != null &&
                          (signupConfirmPasswordController.text ==
                                  signupPasswordController.text &&
                              signupEmailController.text.contains("@"))) {
                        String value = await SignUphelper.signUpUsingEmail(
